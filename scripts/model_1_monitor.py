...
def load_predictions(snapshot_date_str, spark):
    ...
    predictions_file = f"{predictions_dir}model_1_predictions_{file_date_str}.parquet"
...
def main():
    parser = argparse.ArgumentParser(description='Model 1 Monitoring: Calculate performance metrics')
    ...
    print("="*60)
    print(f"Model 1 Monitoring - Logistic Regression")
    print("="*60)
